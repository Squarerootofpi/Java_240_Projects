...
class PersonServiceTest {
    ...
    void servePass() throws Exception {
        try {
            ...
            Response person1 = personService.serve(gL.getAuthToken(),person.getPersonID());
    ...
    void serveFail() throws Exception {
        try {
            ...
            PersonService personService = new PersonService();
            Response person1 = personService.serve("This is a bad auth",person.getPersonID());

            assertEquals(person1.getClass(), ErrorMessage.class);
