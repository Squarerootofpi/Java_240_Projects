...
class AllEventsServiceTest {
    ...
    void servePass() throws Exception {
        try {
            ...
            r = allEventsService.serve(auth);
            AllEvents allEvents2 = ((AllEvents) r);
            System.out.println(allEvents2.size());
            assertEquals(2, allEvents2.size());
    ...
    void serveFail() throws Exception {
        try {
            ...
            AllEventsService allEventsService = new AllEventsService();
            Response allEvents = allEventsService.serve("This is a bad authToken");
